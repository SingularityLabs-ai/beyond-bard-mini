  ...
  return (
    <>
      <Card className="beyondbard--card">
        <div className="beyondbard--flex beyondbard--flex-col beyondbard--gap-3">
          <Radio.Group value={tab} onChange={(v) => setTab(v as ProviderType)}>
            ...
            <Radio value={ProviderType.GPT3}>
              OpenAI API
              <Radio.Desc>
                <div className="beyondbard--flex beyondbard--flex-col beyondbard--gap-2">
                  <span>
                    OpenAI official API, more stable,{' '}
                    <span className="beyondbard--font-semibold">charge by usage</span>
                  </span>
                  <div className="beyondbard--flex beyondbard--flex-row beyondbard--gap-2 beyondbard--geist--select">
                    <Input
                      htmlType="text"
                  ...
                  <span className="beyondbard--italic beyondbard--text-xs">
